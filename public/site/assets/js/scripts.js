var NioApp = function(w, x, n, i) {
    ...
    // Win object ve getStatus objesi tanımlamaları
    ...
    w.getStatus = {};
    w.getStatus.isRTL = !(!u.hasClass("has-rtl") && "rtl" !== u.attr("dir"));
    ...
    w.Util.classInit = function() {
        ...
        !0 === w.getStatus.isTouch ? u.addClass("has-touch") : u.addClass("no-touch");
        a();
        "rtl" === u.attr("dir") && (u.addClass("has-rtl"), w.getStatus.isRTL = !0);
        u.addClass("nk-" + e);
        x(n).on("resize", a);
    };
            ...
            r = {
                ...
                navToggle: function() {
                    e.exists() && e.on("click", function(a) {
                        ...
                        e.toggleClass(d);
                        (s.exists() ? x("#" + t).slideToggle() : x("#" + t).parent()).toggleClass(l);
                ...
                menuToggle: function() {
                    o.exists() && o.on("click", function(a) {
                        var e = x(this).parent();
                        k.width() < m && (e.children(n).slideToggle(400), e.siblings().children(n).slideUp(400), e.toggleClass(i), e.siblings().removeClass(i));
                        a.preventDefault();
                    });
                },
                mobileNav: function() {
                ...
                currentPage: function() {
                    a.exists() && a.each(function() {
                        v === this.href && "" !== f[1] && x(this).closest("li").addClass("active").parent().closest("li").addClass("active");
                ...
                submitHandler: function(t) {
                    ...
                    x(t).ajaxSubmit({
                        ...
                        success: function(a) {
                            ...
                            s.removeClass("alert-danger alert-success").addClass("alert " + e).html(a.message).slideDown(400);
                            "error" !== a.result && x(t).clearForm().find("input").removeClass("input-focused");
                        }
                    });
                }
            });
    ...
    w.Plugins.videoBG = function() {
        ...
        a.exists() && a.each(function() {
            ...
            a.hasClass("bg-video-youtube") && !a.hasClass("cover-enabled") && a.YTPlayer({
                fitToBackground: !0,
                videoId: o,
                callback: function() {
                    console.clear();
