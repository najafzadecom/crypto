...
use App\Http\Requests\Store\CategoryRequest as StoreRequest;
use App\Http\Requests\Update\CategoryRequest as UpdateRequest;
...
class CategoryController extends BaseController
{
    ...
    {
        $this->middleware('permission:categories-index|categories-create|categories-edit', ['only' => ['index']]);
    ...
    public function store(StoreRequest $request)
    {
        ...
        return $this->redirectSuccess('admin.categories.index');
    }
