...
use App\Http\Requests\Store\CountryRequest as StoreRequest;
use App\Http\Requests\Update\CountryRequest as UpdateRequest;
...
class CountryController extends BaseController
{
    ...
    {
        $this->middleware('permission:country-index|country-create|country-edit', ['only' => ['index']]);
    ...
    public function store(StoreRequest $request): RedirectResponse
    {
        ...
        return $this->redirectSuccess('admin.countries.index');
    }
