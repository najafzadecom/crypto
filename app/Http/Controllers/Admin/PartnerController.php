...
use App\Http\Requests\Store\PartnerRequest as StoreRequest;
use App\Http\Requests\Update\PartnerRequest as UpdateRequest;
use App\Services\PartnerService as Service;
...
class PartnerController extends BaseController
{
    ...
    {
        $this->middleware('permission:partner-index|partner-create|partner-edit', ['only' => ['index']]);
