                        ...
                        <div class="col-lg-6">
                            <div class="mb-3">
                                ...
                                <select name="type" class="form-select @error('type') is-invalid @enderror" required>
                                    <option value="">{{ __('Select menu type') }}</option>
                                    <option value="header" {{ old('type', $item->type ?? '') == 'header' ? 'selected' : '' }}>{{ __('Header Menu') }}</option>
                                    <option value="footer" {{ old('type', $item->type ?? '') == 'footer' ? 'selected' : '' }}>{{ __('Footer Menu') }}</option>
                                    <option value="sidebar" {{ old('type', $item->type ?? '') == 'sidebar' ? 'selected' : '' }}>{{ __('Sidebar Menu') }}</option>
                                </select>
                                @error('type')
