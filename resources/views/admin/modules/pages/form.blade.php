                                                ...
                                                <div class="col-lg-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" 
                                                               ...
                                                               class="form-control @error('translations.'.$loop->index.'.meta_title') is-invalid @enderror"
                                                               placeholder="{{ __('Meta title for SEO') }}"
                                                               value="{{ old('translations.'.$loop->index.'.meta_title', $translation->meta_title ?? '') }}">
                                                        @error('translations.'.$loop->index.'.meta_title')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
                                                        @enderror
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <textarea name="translations[{{ $loop->index }}][meta_description]" 
                                                                  class="form-control @error('translations.'.$loop->index.'.meta_description') is-invalid @enderror"
                                                                  rows="3"
                                                                  placeholder="{{ __('Meta description for SEO') }}">{{ old('translations.'.$loop->index.'.meta_description', $translation->meta_description ?? '') }}</textarea>
                                                        @error('translations.'.$loop->index.'.meta_description')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
                                                        @enderror
