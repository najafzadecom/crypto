                                ...
                                <div class="contact-wrap round split split-left split-lg-left bg-white">
                                    ...
                                    <form class="nk-form-submit" action="{{ route('contact') }}" method="post" novalidate="novalidate">
                                        ...
                                        <div class="field-item">
                                            ...
                                            <label class="field-label field-label-line">{{ __('Your Name') }}</label>
                                        </div>
                                        <div class="field-item">
                                            <input name="email" type="email" class="input-line required email" aria-required="true">
                                            <label class="field-label field-label-line">{{ __('Your Email') }}</label>
                                        </div>
                                        <div class="field-item">
                                            <textarea name="message" class="input-line input-textarea required" aria-required="true"></textarea>
                                            <label class="field-label field-label-line">{{ __('Your Message') }}</label>
                                        </div>
                                        <input type="text" class="d-none" name="form-anti-honeypot" value="">
                                        <div class="row">
                                            <div class="col-sm-4">
                                                <button type="submit" class="btn btn-lg btn-grad">{{ __('Submit') }}</button>
                                            </div>
                                            <div class="col-sm-8">
